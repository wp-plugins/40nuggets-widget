...
class Fortynuggets_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', '40Nuggets'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', '40Nuggets'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', '40Nuggets'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', '40Nuggets'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', '40Nuggets');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', '40Nuggets'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', '40Nuggets');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', '40Nuggets'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', '40Nuggets') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', '40Nuggets');
            case 'false':
                return __('false', '40Nuggets');

            case 'Administrator':
                return __('Administrator', '40Nuggets');
            case 'Editor':
                return __('Editor', '40Nuggets');
            case 'Author':
                return __('Author', '40Nuggets');
            case 'Contributor':
                return __('Contributor', '40Nuggets');
            case 'Subscriber':
                return __('Subscriber', '40Nuggets');
            case 'Anyone':
                return __('Anyone', '40Nuggets');
        }
        return $optionValue;
    }
